...
const content = {
  ru: {
    ...
    forWhom: {
      ...
      p1: 'Наши туры — для тех, кто устал откладывать себя на потом. Кто хочет быстрее и эффективнее разобраться в себе.',
      p2: 'С нами едут обычные люди, без обязательных супер-травм и диагнозов. Но с обязательным интересом - к новому опыту, к групповой терапии, к путешествию без привычной семейной роли. Им важно: не просидеть эту часть жизни в обыденности, а рискнуть иначе!',
